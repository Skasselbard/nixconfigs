# Generated by Powerlevel10k configuration wizard on 2023-12-07 at 16:14 CET.
...
# blurred tails, 2 lines, solid, right frame, darkest-ornaments, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    dir_writable            # icon, if you do not have write permissions on the current folder.
    vcs                     # git status
    # =========================[ Line #2 ]=========================
    newline                 # \n
